  ...
  return (
    <div className="App">
      ...
      <div className="App-boards">
        <Board className="" name="나" color="blue" /*num={num} sum={sum}*/ gameHistory={gameHistory}/>
        <Board name="상대" color="red" /*num={numOther} sum={sumOther}*/ gameHistory={gameHistoryOther}/>
      </div>
    </div>
  );
}
